...
x = [1.6 1.0 2.0 4.0 5.5 4.3 4.0 3.0 2.0 1.0 2.0 3.0 4.3 5.0 6.0 4.0 ...
  3.4 4.0 5.0 6.0 5.8 6.0 7.1 8.0 7.4 8.6 9.5 9.5 8.5 7.4 8 7.8 6.5 9.5];
y = [6.0 4.0 3.9 5.0 5.8 3.9 3.5 2.2 1.5 1.6 3.0 3.6 3.9 4.0 4.0 3.1 ...
 ...
 hold on
 plot(x, y, 'bo', 'MarkerFaceColor', 'k') % plot data points
 axis([-0.2 6 -0.2 5])
 grid on
