function plotWord(word)
    ...
    letterShapes('c') = [4.2,2.5;3.5,3;2,2;3,1.3;4.2,1.5];
    letterShapes('d') = [3.4,2.5;3,3;3,1.5;3,0.3;3.5,0.3;2.8,0.4;2,0.7;...
    3.2,1.4];
    letterShapes('e') = [1,2;2,1.8;3.2,2.5;2,2.5;2,1.3;3.5,1.5];
    letterShapes('f') = [3,3.2;2,3.2;2.8,0.5;2.5,0.5;3,2;3,1.8;1.8,2];
    letterShapes('g') = [3.5,1.5;2.5,1.3;1.8,1;2.7,1;3,3.5;1.8,3;3.5,2.6];
